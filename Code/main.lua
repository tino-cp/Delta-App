    ...
    if Enable == true then
      ...
      if FirstLap==false then
        ...
        if CurCheckpoint==0 then
          ...
          print(FastLapSectors[CurCheckpoint])
          print(CurrentLapSectors[CurCheckpoint])
...
function FindAdr()
  ...
  local results = AOBScan('?? ?? 0? 00 00 00 00 00 01 00 00 00 00 00 00 00 ?? 00 00 00 ?? 0? 00 00 ?? 00 00 00 ?? 0? 00 00 0? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 0? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 FF FF FF FF 00 00 00 00 FF FF FF FF', '-X-C+W', 1, '8')
