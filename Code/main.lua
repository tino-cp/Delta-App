...
function InitTrackInfo()
  ...
  S2_raw=0
  S3_raw=0
  MaxCheckpoints = readInteger('GTA5.exe+26A435C')
  ...
  UI.Caption = Track_Name.." - Delta App Online 1.2.11"
...
function UpdateInfo()
  ...
  if Enable == true then
    ...
    UI.Caption = "Delta App Online 1.2.11"
...
--end                      15 58 02 00 00 00 00 00 FF FF FF FF 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 C9 06 FF C3 AC 01 00 00 66 F5 94 45 00 00 00 00 1F 85 70 43 00 00 00 00 3E 5F A0 42 AC 01 00 00 05 00 D1 11 AC 01


function FindSetup()
  local results = AOBScan('00 00 80 BF 00 00 80 BF 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? ?? ?? ?? 45 ?? ?? ?? 42 F6 7F 00 00 ?? ?? ?? ?? ?? ?? ?? 3F 00 00 00 00 00 00 00 00 ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? ?? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00', '-X-C+W', 1, '')
  assert(results, 'aobscan failed')
  local addr = results[0]
  results.destroy()
  registerSymbol('SetupPTR',addr)
end

function FindTimes()
  Enable.Caption = "Scanning memory 1/2"
  local results = AOBScan('?? ?? ?? 00 ?? 0? 00 00 FF FF FF FF 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 ?? ?? ?? ?? ?? 0? 00 00 ?? ?? ?? ?? 00 00 00 00 ?? ?? ?? 4? 00 00 00 00 ?? ?? ?? 4? ?? 0? 00 00 ?? 00 ?? ?? ?? 0? 00 00 ?? 0? 00 00 ?? 0? 00 00 0? 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 FF FF FF FF', '-X-C+W', 1, '8')
  assert(results, 'aobscan failed')
  local addr = results[0]
  results.destroy()  
