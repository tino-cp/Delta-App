function createUI()
  ...
  S12ProggressBar = createLabel(UI)
    S12ProggressBar.Left = 138
    S12ProggressBar.Height = 17
    S12ProggressBar.Top = 183
    S12ProggressBar.Width = 37
    S12ProggressBar.Caption = 'S1 | S2'
    S12ProggressBar.Font.Color = clMenuBar
    S12ProggressBar.Font.Height = -13
    S12ProggressBar.Font.Name = 'Segoe UI'
    S12ProggressBar.Font.fsItalic = true
    S12ProggressBar.ParentColor = false
    S12ProggressBar.ParentFont = false

  S23ProggressBar = createLabel(UI)
    S23ProggressBar.Left = 304
    S23ProggressBar.Height = 17
    S23ProggressBar.Top = 183
    S23ProggressBar.Width = 37
    S23ProggressBar.Caption = 'S2 | S3'
    S23ProggressBar.Font.Color = clMenuBar
    S23ProggressBar.Font.Height = -13
    S23ProggressBar.Font.Name = 'Segoe UI'
    S23ProggressBar.Font.fsItalic = true
    S23ProggressBar.ParentColor = false
    S23ProggressBar.ParentFont = false
